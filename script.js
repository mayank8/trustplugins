    ...
    const plugins = [
        {
            ...
            description: 'A privacy-first time tracker that runs entirely locally. Visualize your browsing habits, identify distractions, and reclaim your focus with advanced analytics and circadian rhythm maps.',
            features: [
            ...
            storeLink: '#', // Placeholder for now
            detailsLink: '#' // Placeholder
        },
        {
            id: 'gocapture',
            name: 'GoCapture',
            tagline: 'The truly free, 4K screen recorder.',
            description: 'Capture your screen, system audio, and microphone without limits. No watermarks, no sign-ups, just pure utility. Supports Full HD and 4K exports.',
            features: [
                'Unlimited Recording Duration',
                '4K & Full HD Export Quality',
                'Focus Mode & Virtual Backgrounds'
            ],
